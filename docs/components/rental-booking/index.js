...
const addRentalBookingRequestBody = {
    description: 'Book new rental request body.',
    content: {
      'application/json': {
        schema: {
          type: 'object',
          ...
          properties: rentalObjectSchema
        }
      }
    }
}

const updateRentalBookingBody = {
  description: 'Update rental request body.',
  content: {
    'application/json': {
      schema: {
        type: 'object',
        ...
        properties: {
          ...
          description: {
            type: 'string',
            maxLength: 500,
            example:"This is test rental description"
          },
          shortDescription: {
              type: 'string',
              maxLength: 250,
              example:"This is test rental short description"
            },
          category: {
            type: 'string',
...
const addRentalBooking201 = {
  ...
  const getAllRentalBooking200 = {
    description: 'Get all rental bookings',
    content: {
      'application/json': {
        schema: {
          type: 'object',
