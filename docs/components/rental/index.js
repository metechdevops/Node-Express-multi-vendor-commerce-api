...
const addRentalRequestBody = {
    description: 'Add new rental request body.',
    content: {
      'application/json': {
        schema: {
          type: 'object',
...
const addRental201 = {
    description: 'Add New Rental 201 response',
    content: {
      'application/json': {
        schema: {
          type: 'object',
