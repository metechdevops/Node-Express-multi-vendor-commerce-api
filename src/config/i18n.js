...
export const messages = {
  en: {
    ...
    isOutOfStock: 'Product quantity mismatch or out of stock.',
    ...
    noServiceFound: 'No service found with this ID.',
    noRentalFound: 'No rental found with this ID.',
    productExist: 'Product already exits',
    serviceExist: 'Service already exits',
    rentalExist: 'Rental already exits',
    ...
    noRentalsInFavorite: 'No rentals on the favorite list found',
    ...
    notServiceFoundInFavoriteList: 'Service not found in favorite list.',
    notRentalFoundInFavoriteList: 'Rental not found in favorite list.',
    ...
    successfulDeleteServiceFromFavorite:'Service deleted from favorite list successfully.',
    successfulDeleteServiceFromFavorite:'Service deleted from favorite list successfully.',
    successfulDeleteRentalFromFavorite:'Rental deleted from favorite list successfully.',
    successfulProductFoundInFavorite: 'Product in favorite list.',
    successfulServiceFoundInFavorite: 'Service in favorite list.',
    successfulRentalFoundInFavorite: 'Rental in favorite list.',
